...
NUM_TRAIN: int = 8 # Колличество искаженных картинок для обучения из 1
NUM_VAL: int = 3 # Колличество искаженных картинок для валидации из 1

IMAGE_SIZE: int = 256 # Желаемый размер картинки 256х256
OBJECT_SIZE: int = 110 # Изначальный размер картинки 110х110
NUM_IMAGES: int = 8 # Колличество картинок из 1 разного позицианирования на холсте 256х256
